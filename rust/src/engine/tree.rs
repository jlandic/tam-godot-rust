...
pub unsafe fn get_tile_map(tile_map_name: &str, owner: &Node, recursive: bool) -> Option<Ref<TileMap, Unique>> {
    owner
...
pub unsafe fn get_tile_set(tile_map_name: &str, owner: &Node, recursive: bool) -> Option<Ref<TileSet, Unique>> {
